<div id="division-id-field" class="form-group {{ $errors->has('division_id') ? 'has-error' : ''}}">
...
<div id="match-number-field" class="form-group {{ $errors->has('match_number') ? 'has-error' : ''}}">
...
<div id="match-date-field" class="form-group {{ $errors->has('match_date') ? 'has-error' : ''}}">
...
<div id="warm-up-time-field" class="form-group {{ $errors->has('warm_up_time') ? 'has-error' : ''}}">
...
<div id="start-time-field" class="form-group {{ $errors->has('start_time') ? 'has-error' : ''}}">
...
<div id="home-team-id-field" class="form-group {{ $errors->has('home_team_id') ? 'has-error' : ''}}">
...
<div id="away-team-id-field" class="form-group {{ $errors->has('away_team_id') ? 'has-error' : ''}}">
...
<div id="venue-id-field" class="form-group {{ $errors->has('venue_id') ? 'has-error' : ''}}">
...
<div id="notes-field" class="form-group {{ $errors->has('notes') ? 'has-error' : ''}}">

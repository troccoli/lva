...
class SeasonsTest extends TestCase
{
    ...
    public function testGettingAllSeasonsAsSeasonAdministrator(): void
    {
        ...
        Passport::actingAs($this->userWithRole(RolesHelper::seasonAdminName($season1)));
    ...
    public function testGettingAllSeasonsAsCompetitionAdministrator(): void
    {
        ...
        Passport::actingAs($this->userWithRole(RolesHelper::competitionAdminName($competition1_season1)));
    ...
    /* - all seasons with competitions => only season 1 with its competitions */
    ...
    public function testGettingAllSeasonsAsDivisionAdministrator(): void
    {
        ...
        Passport::actingAs($this->userWithRole(RolesHelper::divisionAdminName($division1)));
    ...
    public function testGettingAllSeasonsAsClubSecretary(): void
    {
        ...
        Passport::actingAs($this->userWithRole(RolesHelper::clubSecretaryName($club)));
    ...
    public function testGettingAllSeasonsAsTeamSecretary(): void
    {
        ...
        Passport::actingAs($this->userWithRole(RolesHelper::teamSecretaryName($team)));
